...
$sql=("UPDATE student_info SET name='$_POST[name]',dept='$_POST[dept]',email='$_POST[email]',gender='$_POST[gender]',cgpa='$_POST[cgpa]',pass=MD5('$_POST[pass]') WHERE id='$_POST[id]'");// Update table_name
