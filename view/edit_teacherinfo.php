<div id="add_stuinfo">
<form action="action/update_teacher.php" name="add_stuinfo" method="post" onSubmit="return validateForm()" id="add_stuinfo" >
<table align="center" width="500px" border="0">
	<tr>
		<td colspan="2" align="center" bgcolor="#99FFFF"> <h3>Edit Teacher's Information</h3></td>
	</tr>
	
	<tr>
	<td colspan="1" align="center">Id :</td>
	<td colspan="1" align="center"><input name="id" value="<?php echo "$_GET[user_id]"; ?>" /></td>
	</tr>
	<tr>
...
<label id="dept1" style="color:#FF0000"></label></td>
	...
	<tr>
		<td align="center"><label for="degree">Degree:</label></td>
		<td align="center"><input type="text" name="degree"  id="cgpa" width="250px" value="<?php echo "$_GET[degree]"; ?>"/></td><label id="cgpa1" style="color:#FF0000"></label>
	</tr>	
	<tr>
