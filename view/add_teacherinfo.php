<div id="add_teacherinfo">
<form action="action/add_teacher.php" name="add_teacherinfo" method="post" onsubmit="return validateForm()" id="add_teacherinfo" >
<table align="center" width="500px" border="0">
	<tr>
		<td colspan="3" align="center" bgcolor="#99FFFF"> <h3>Add Teacher Information</h3></td>
	</tr>
	...
	<tr>
		...
		<td colspan="2"><select style="width:100px" id="dept"  name="dept" >
						  ...
						  <option value="B.Arth">B.Arth</option>
	...
	<tr>
		...
		<td><fieldset style="width:70px" id="gender">
	...
	<tr>
		...
		<td><input type="text" name="degree"  id="degree"/></td><label id="degree1" style="color:#FF0000"></label>
	</tr>	
	<tr>
